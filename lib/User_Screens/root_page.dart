...
class RootPage extends StatefulWidget {
  //ROOT PAGE TAKES AUTH INSTANCE , SO AS TO CHECK IF USER IS LOGGED IN OR NOT ...SEE INITSTATE
  final BaseAuth auth;
...
class _RootPageState extends State<RootPage> {
  ...
  // BOTH THESE METHODS ARE INVOKED FROM THE LOGIN PAGE AND HOME PAGE RESPECTIVELY, BY CALL BACK METHODS.
